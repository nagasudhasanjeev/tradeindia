...
Route::group(['middleware' => ['auth', 'activated', 'currentUser', 'activity', 'twostep', 'checkblocked']], function () {
    ...
    Route::get('trades', 'App\Http\Controllers\SellorderController@list');
    Route::get('myorders', 'App\Http\Controllers\BuyorderController@index');
    Route::post('buyorder/store', 'App\Http\Controllers\BuyorderController@store');
});
...
Route::group(['middleware' => ['auth', 'activated', 'role:admin', 'activity', 'twostep', 'checkblocked']], function () {
    ...
    Route::get('sellorders', 'App\Http\Controllers\SellorderController@index');
    Route::get('sellorders/create', 'App\Http\Controllers\SellorderController@create');
    Route::post('sellorders/store', 'App\Http\Controllers\SellorderController@store');
    Route::get('sellorders/{sellorder}/edit', 'App\Http\Controllers\SellorderController@edit');
    Route::put('sellorders/update/{sellorder}', 'App\Http\Controllers\SellorderController@update');
    Route::delete('sellorders/{sellorder}/delete', 'App\Http\Controllers\SellorderController@destroy');
});
