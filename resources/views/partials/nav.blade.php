                ...
                @role('admin')
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item {{ Request::is('sellorders/') ? 'active' : null }}" href="{{ url('sellorders/') }}">
                                Sellorders
                            </a>
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            @role('user')
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item {{ Request::is('trades/', 'trades/') ? 'active' : null }}" href="{{ url('/trades/') }}">
                                Trade
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item {{ Request::is('myorders/', 'myorders/') ? 'active' : null }}" href="{{ url('/myorders/') }}">
                                My Orders
                            </a>
