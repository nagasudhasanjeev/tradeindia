        ...
        <div class="row">
            <div class="col-12 col-xl-10 offset-xl-1">
                <div class="card">
                    ...
                    {!! Form::open(array('action' => 'SellorderController@store', 'method' => 'POST', 'role' => 'form')) !!}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('link') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('price', 0, array('id' => 'price', 'class' => 'form-control')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('link') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('qty', 0, array('id' => 'qty', 'class' => 'form-control','onchange' => 'calc()')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('link') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('total', null, array('id' => 'total', 'class' => 'form-control','readonly')) !!}
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-sm-6 offset-sm-6">
                                    {!! Form::button('<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Add Sellorders', array('class' => 'btn btn-success btn-block mb-0','type' => 'submit', )) !!}
                                </div>
                            </div>
                        </div>
