                ...
                <?php if (Auth::check() && Auth::user()->hasRole('admin')): ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item <?php echo e(Request::is('sellorders/') ? 'active' : null); ?>" href="<?php echo e(url('sellorders/')); ?>">
                                Sellorders
                            </a>
                ...
                <?php else: ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item <?php echo e(Request::is('trades/', 'trades/') ? 'active' : null); ?>" href="<?php echo e(url('/trades/')); ?>">
                                Trade
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item <?php echo e(Request::is('myorders/', 'myorders/') ? 'active' : null); ?>" href="<?php echo e(url('/myorders/')); ?>">
                                My Orders
                            </a>
...
<?php /**PATH D:\subhashini\tradeindia\resources\views/partials/nav.blade.php ENDPATH**/ ?>